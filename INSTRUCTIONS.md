### 1. Fill a file with the sql code that creates 3 tables: students, courses and enrolments (which student takes which courses). Write insert scripts to populate these tables.
